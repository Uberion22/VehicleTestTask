...
var passengerCar = new PassengerCar(VehicleEngineType.Gasoline, 5.0f, 40.0f, 30.0f, 4);
...
var freightCar = new FreightСar(VehicleEngineType.Gasoline, 5.0f, 40.0f, 30.0f, 700);
